...
<details>
<summary><strong>3. 회원 점수 조회</strong></summary>

- 회원의 점수를 조회 할 수 있는 기능으로,  에버리지, 최고와 최저점 그리고 기준에버와 편차를 통해 점수 향상 여부를 확인 할 수 있습니다.
<img width="646" height="345" alt="회원 점수 조회" src="https://github.com/user-attachments/assets/ce067f9a-122c-4b2e-895d-a9d04ab0f9c1" />

- 정렬 조건 설정을 통해 에버리지(총핀), 기준에버, 향상(편차), 하이로우(최고와 최저점 차이)를 선택하여 정렬 할 수 있습니다
![프레젠테이션1](https://github.com/user-attachments/assets/8efb188d-c9d2-43a6-ab53-14b5c6dec001)

- **조회 조건**
  - 조회 기준은 설정된 기간내 조회와 특정 모임을 지정하여 조회 할 수 있습니다.
    - 기간내 조회는 설정된 기간내 모든 게임을 합산하여 에버리지를 계산합니다.
    - 모임 지정 조회는 선택된 모임의 참가자만 조회 되며, 해당 모임의 각 게임별 점수와 에버리지를 계산합니다.
    ![회원 점수 조회_모임기준](https://github.com/user-attachments/assets/ba33cab8-1dee-4c3b-b7a2-990acc460116)

  - 특정 회원을 더블 클릭하면 개인의 기간내 각 모임별 에버리지 그래프와 게임 점수를 조회 할 수 있습니다.
    - 기간을 1개월, 3개월, 6개월, 전체로 선택하여 조회 할 수 있습니다.
    ![회원 점수 조회_모임기준](https://github.com/user-attachments/assets/640441d2-61f0-4c0c-851c-123163a615af)

- **회원 등급**
  - 원활한 조편성을 위해 개인의 등급을 설정을 할 수 있도록 기능이 추가 되었습니다.
  - 조회 설정 방법
    - 등급 설정은 개인 설정과 일괄 설정 두 가지 방법이 있습니다.
    - 회원 상세 정보에서 회원 등급을 수정할 수 있습니다.
    <img width="491" height="228" alt="등급 수정_개인설정" src="https://github.com/user-attachments/assets/bbc38bd4-dbbb-4013-babd-0e9c481006c5" />
  
  - 조회된 회원을 드레그로 선택 후 우클릭을 통해 회원 등급 일괄 수정 할 수 있습니다.
  ![회원점수조회_일괄 수정](https://github.com/user-attachments/assets/7c155430-14dd-439f-a058-3b68b4ab6fa2)
-**기준 에버**
  - 조회 또는 지정 모임의 직전 에버리지로, 해당 값은 별도로 저장되어 있지 않고 설정된 기간내 점수를 통해 만들어집니다.
  - 기준 에버 기간 설정은 `기준 에버 설정` 버튼을 클릭하여 1개월 ,3개월, 6개월, 1년 중 선택하여 설정 할 수 있습니다.
    <img width="511" height="311" alt="image" src="https://github.com/user-attachments/assets/6273cda8-7806-471b-8044-0838f1ba0117" />
  - 기준 에버 생성 기준 예시
    - 기준에버 생성 조건을 3개월로 설정으로 가정.
    - 6월1일부터 30일까지 조회를 한다면 기준 에버는 6월1일 이전의 직전 3개월의 모든 정기전 게임의 평균 점수가 기준 에버가 됩니다.
    - 모임 지정의 기준 에버는 해당 모임날짜 이전의 직전 3개월의 모든 정기전 게임의 평균 점수가 기준에버가 되며, `모임 등록` 메뉴에서 참가자로 등록 하였을때 설정 됩니다.

</details>

<details>
<summary><strong>4. 모임 관리</strong></summary>
...
<details>
<summary><strong>5. 게임 기록</strong></summary>
